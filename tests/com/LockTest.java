...
public class LockTest {
	...
	private static void testTurnAntiClockWise() {
		...
		// turns the drive cam only
		lock.turnAntiClockwise(10);
		assert (lock.getWheelPosition(0).equals("10:10:10"));
		assert(lock.getWheelPosition(1).equals("13:3:0"));
		assert(lock.getWheelPosition(2).equals("5:4:0"));
		assert(lock.getWheelPosition(3).equals("12:2:0"));
		...
		lock.turnAntiClockwise(10);
		assert(lock.getWheelPosition(0).equals("0:0:0"));
		assert(lock.getWheelPosition(1).equals("9:19:16"));
		assert(lock.getWheelPosition(2).equals("5:4:0"));
		assert(lock.getWheelPosition(3).equals("12:2:0"));
		
		// turns the rear, middle, front wheel
		lock.turnAntiClockwise(8);
		assert(lock.getWheelPosition(0).equals("12:12:12"));
		assert(lock.getWheelPosition(1).equals("1:11:8"));
		//assert(lock.getWheelPosition(2).equals("19:0:15"));
		//assert(lock.getWheelPosition(3).equals("12:2:0"));
